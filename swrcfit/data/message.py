def message(lang, ID, URL='./'):
    ...
    if ID == 'news':
        if lang == 'ja':
            return '<strong>[ニュース]</strong><ul><li>団粒土に対するdual-VGの精度を向上させた<a href="https://doi.org/10.34467/jssoilphysics.155.0_35">論文</a>が<strong>土壌物理学会賞</strong>を受賞しました。</li><li><a href="https://doi.org/10.1002/vzj2.20168">この論文</a>の線型結合モデルに対応した新しいバージョンになりました。</li><li><a href="https://sekika.github.io/unsoda/">UNSODA viewer</a> と <a href="https://sekika.github.io/unsatfit/">unsatfit</a> と <a href="https://sekika.github.io/hystfit/">hystfit</a> もどうぞ。</li></ul>'
