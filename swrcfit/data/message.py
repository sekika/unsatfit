def message(lang, ID, URL='./'):
    ...
    if ID == 'news':
        if lang == 'ja':
            return '<strong>[ニュース]</strong><ul><li><a href="https://doi.org/10.1002/vzj2.20168">この論文</a>の線型結合モデルに対応した新しいバージョンになりました。</li><li>団粒土に対するdual-VGの精度が向上しました。<a href="https://doi.org/10.34467/jssoilphysics.155.0_35">論文</a>、<a href="https://researchmap.jp/sekik/presentations/43218823/attachment_file.pdf">学会発表スライド</a>。</li><li><a href="https://sekika.github.io/unsoda/">UNSODA viewer</a> と <a href="https://sekika.github.io/unsatfit/">unsatfit</a> と <a href="https://sekika.github.io/hystfit/">hystfit</a> もどうぞ。</li></ul>'
        return '<strong>[News]</strong><ul><li>This is a completely new version of SWRC Fit with bimodal models in <a href="https://doi.org/10.1002/vzj2.20168">this publication</a>.</li><li><a href="https://doi.org/10.34467/jssoilphysics.155.0_35">Improvement of dual-VG model</a> was implemented.</li><li>Please also check <a href="https://sekika.github.io/unsoda/">UNSODA viewer</a>, <a href="https://sekika.github.io/unsatfit/">unsatfit</a> and <a href="https://sekika.github.io/hystfit/">hystfit</a>.</li></ul>'
    if ID == 'description':
        if lang == 'ja':
