def init_lsq(self):
    ...
    self.lsq_loss = 'linear'  # Loss function. ‘linear’, ‘soft_l1’, ‘huber’, ‘cauchy', ‘arctan’
    self.lsq_verbose = 0  # Level of algorithm’s verbosity. (0, 1, 2)
    self.lsq_ftol = [0.1, 0.01, 1e-3, 1e-4, 1e-6, 1e-8]  # ftol changes stepwise in this order
    self.lsq_ftol_global = [1, 0.1]  # ftol for initial estimation of mutiple initial parameter sets
