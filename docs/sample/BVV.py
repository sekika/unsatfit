...
f.unsat = (h_k, k)
f.b_h1 = (MIN_H, np.inf)
f.b_a2 = f.b_a3 = (0, 1 / MIN_H)
f.b_m = (0, 1 - 1 / MAX_N)
w1, hb1, l1, ww2, alpha2, m2, alpha3, m3 = f.get_init_bvv()
wrf = (max(theta), 0, w1, hb1, l1, ww2, alpha2, m2, alpha3, m3, 1)
w2 = (1-w1) * ww2
n2, n3 = [1 / (1 - m) for m in (m2, m3)]
...
print(f'Therefore w2 = {w2:.3f} n2 = {n2:.3f} n3 = {n3:.3f}')
