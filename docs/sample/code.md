...
- Prepare datafile as csv (comma-separated values) format for (h, &theta;) data in the filename “swrc.csv” with a header of “h, theta”. See sample data of clay (Unsoda 2362).
- Prepare (h, K) data in the filename “hcc.csv” with a header of “h, K”. See sample data of clay (Unsoda 2362).
...
- Use sample code for DBC model. See instruction in the VGM model above.
...
## Contour plot
- Sample code. See instruction in the VGM model above.
