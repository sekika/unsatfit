...
f.b_m = (0, 1 - 1 / MAX_N)
w1, alpha1, m1, ww2, alpha2, m2, alpha3, m3 = f.get_init_vg3()
wrf = (max(theta), 0, w1, alpha1, m1, ww2, alpha2, m2, alpha3, m3, 1)
w2 = (1-w1) * ww2
...
print(f'Therefore w2 = {w2:.3f} n1 = {n1:.3f} n2 = {n2:.3f} n3 = {n3:.3f}')
